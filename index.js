...
var CONNECTION_STRING = "mongodb+srv://ikki:ikkiFenix07@cluster0.zsvfj.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
...
app.get("/api/department", (request, response) => {
    ...
    database.collection("Departament").find({}).toArray((error, result) => {
if (error) {
    console.log(error)
}
